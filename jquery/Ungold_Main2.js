...
function loadTitle() {
  ...
  titleImage.src = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1524180/HappyHolidays_copy.png";
  
  clickImage = new Image();
  clickImage.onload = handleImage2Load;
  clickImage.src = "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1524180/ClickForMusic.png";
}
...
function init() {
  ...
  setTimeout(function () {
    jam = new JustAddMusic({
      src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/1524180/musicJiggle.mp3",
      ui:false,
      onstart:function () {
        readyToJam();
      },
